namespace ExamineMd.PackageActions
{
    ...
    public class AddExamineConfigs : IPackageAction
    {
        ...
        public string Alias()
        {
            return string.Concat(ExamineMd.Constants.PackageName, "_AddExamineConfigs");
        }
        ...
        {      
            ...
            var indexSets = xmlData.SelectNodes("//ExamineMdIndexSets/IndexSet");
            var indexers = xmlData.SelectNodes("//ExamineMdIndexProviders/add");
            var searchers = xmlData.SelectNodes("//ExamineMdSearchProviders/add");
        ...
        public bool Undo(string packageName, XmlNode xmlData)
        {
            ...
            var indexSets = xmlData.SelectNodes("//ExamineMdIndexSets/IndexSet");
            var indexers = xmlData.SelectNodes("//ExamineMdIndexProviders/add");
            var searchers = xmlData.SelectNodes("//ExamineSearchProviders/add");
        ...
        public XmlNode SampleXml()
        {
            string sample =
                "<Action runat=\"install\" undo=\"true\" alias=\"AddExamineIndex\">" +
                  "<ExamineMdIndexSets>" +
                    "<IndexSet SetName=\"ExamineMdIndexSet\" IndexPath=\"~/App_Data/TEMP/ExamineIndexes/ExamineMd/\" />" + 
                  "</ExamineMdIndexSets>" +
                  "<ExamineMdIndexProviders>" +
                    "<add name=\"ExamineMdIndexer\" type=\"Examine.LuceneEngine.Providers.SimpleDataIndexer, Examine\" />" +
                  "</ExamineMdIndexProviders>" +
                  "<ExamineMdSearchProviders>" +
