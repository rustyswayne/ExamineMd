namespace ExamineMd.PackageActions
{
    ...
    public class AddAppSetting : IPackageAction
    {
        ...
        /// The key.
        /// </summary>
        private const string Key = "ExamineMd:MdRootDirectory";
        ...
        public string Alias()
        {
            return string.Concat(Constants.PackageName, "_AddAppConfigKey");
        }
        ...
        public bool Execute(string packageName, XmlNode xmlData)
        {
            try
            {
                CreateAppSettingsKey(Key, "~/App_Data/ExamineMdRoot/");
